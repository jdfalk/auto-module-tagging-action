...
- All changes to module tagging logic should be made in the embedded Python script within action.yml.
...
This repository provides a composite GitHub Action that automatically tags Go modules in monorepos.
